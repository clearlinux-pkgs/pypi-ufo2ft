...
Version  : 3.3.1
Release  : 22
URL      : https://files.pythonhosted.org/packages/8f/4d/dd5f13b2dcf01b534edd1501ba7a018ced29eeaa440163e9e0e07f8699ba/ufo2ft-3.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8f/4d/dd5f13b2dcf01b534edd1501ba7a018ced29eeaa440163e9e0e07f8699ba/ufo2ft-3.3.1.tar.gz
...
%prep
%setup -q -n ufo2ft-3.3.1
cd %{_builddir}/ufo2ft-3.3.1
pushd ..
cp -a ufo2ft-3.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728568677
